                            ...
                            <Button type="link" href={`/project/${item.id}`}>
                                <div className="group rounded-2xl shadow-xl w-auto w-11/12 m-3 transform transition duration-500 hover:scale-110 portofolio-card">
                                    <div className="relative">
                                        {item.imageUrl === 'assets/images/Recruiting.png' && <img src={recruitingImage} alt="Portfolio" className="rounded-t-2xl z-0" />}
                                        {item.imageUrl === 'assets/images/Stream.png' && <img src={streamImage} alt="Portfolio" className="rounded-t-2xl z-0" />}
                                        {item.imageUrl === 'assets/images/Freelance.png' && <img src={freelanceImage} alt="Portfolio" className="rounded-t-2xl z-0" />}
                                        {item.imageUrl === 'assets/images/Aura.png' && <img src={auraImage} alt="Portfolio" className="rounded-t-2xl z-0" />}
                                        {item.imageUrl === 'assets/images/Surtido.png' && <img src={surtidoImage} alt="Portfolio" className="rounded-t-2xl z-0" />}
                                        {item.imageUrl === 'assets/images/ManagementApp.png' && <img src={managementImage} alt="Portfolio" className="rounded-t-2xl z-0" />}
